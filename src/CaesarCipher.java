...
public class CaesarCipher {
    ...
    private static final HashSet<String> FREQUENT_WORDS = new HashSet<>() {{
        add("и");       add("что");     add("до");          add("во");
        add("в");       add("весь");    add("время");       add("со");
        add("не");      add("год");     add("если");        add("раз");
        add("на");      add("от");      add("сам");         add("где");
        add("я");       add("так");     add("когда");       add("там");
        add("быть");    add("о");       add("другой");      add("под");
        add("он");      add("для");     add("вот");         add("можно");
        add("с");       add("ты");      add("говорить");    add("ну");
        add("сейчас");  add("же");      add("наш");         add("какой");
        add("а");       add("все");     add("мой");         add("после");
        add("по");      add("тот");     add("знать");       add("их");
        add("это");     add("мочь");    add("стать");       add("работа");
        add("она");     add("вы");      add("при");         add("без");
        add("этот");    add("человек"); add("чтобы");       add("самый");
        add("к");       add("такой");   add("дело");        add("потом");
        add("но");      add("его");     add("жизнь");       add("надо");
        add("они");     add("сказать"); add("кто");         add("хотеть");
        add("мы");      add("только");  add("первый");      add("ли");
        add("тут");     add("или");     add("очень");       add("слово");
        add("из");      add("ещё");     add("два");         add("идти");
        add("у");       add("бы");      add("день");        add("большой");
        add("который"); add("себя");    add("её");          add("должен");
        add("то");      add("один");    add("новый");       add("место");
